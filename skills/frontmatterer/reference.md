...
prerequisites: { type: Array, desc: "Required reading/tasks/documents. Use wikilink format: \"[[filename]]\" or \"[[filename#heading]]\". If no related doc exists, use plain string: - 完成 Google Ads 帳號註冊" }
related: { type: Array, desc: "Related documents (Obsidian wikilink format, e.g., \"[[管理者權限與後台選單對應表]]\")" }
tags: { type: Array, required: true, desc: "SEO internal keywords" }
