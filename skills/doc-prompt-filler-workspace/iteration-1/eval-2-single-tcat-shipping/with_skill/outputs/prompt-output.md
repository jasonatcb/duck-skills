...
* **主文**:`docs/payments-and-logistics/tcat-shipping.md`(例如 `docs/orders/search-and-filter.md`)
...
6. ☐ 列表項目皆為單一物理行(§C-1)
7. ☐ 對照表已拆檔到 `docs/payments-and-logistics/references/`,主文用 `data-preview` 跳轉
8. ☐ 新舊版差異(若適用)已用 `=== "..."` 分頁呈現
...
* 若新增了對照表,提供對照表的目標檔案路徑(`docs/payments-and-logistics/references/{{file}}.md`)
...
這是給 Firebase CYBERBIZ 後端專案的 **Claude Code** 使用的 doc-generator prompt。複製後到該專案中貼上執行即可開始研究程式碼並產出文件。
